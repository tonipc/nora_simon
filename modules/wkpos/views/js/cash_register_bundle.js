...
// CONCATENATED MODULE: /home/users/sanjay.singh/www/html/ps_1761/modules/wkpos/views/js/app/js/wkgrowlmsg.js
/**
 * NOTICE OF LICENSE
 *
...
// EXTERNAL MODULE: /home/users/sanjay.singh/www/html/ps_1761/modules/wkpos/views/js/node_modules/jquery/dist/jquery.js
var jquery = __webpack_require__(0);
var jquery_default = /*#__PURE__*/__webpack_require__.n(jquery);

// CONCATENATED MODULE: /home/users/sanjay.singh/www/html/ps_1761/modules/wkpos/views/js/app/js/wkajaxresponseerror.js
/**
* NOTICE OF LICENSE
*
* This source file is subject to the Academic Free License version 3.0
...
function ajaxResposeError(jqXHR, exception) {
    ...
    jquery_default.a.growl.error({ title: "", message: msg });
}
// CONCATENATED MODULE: /home/users/sanjay.singh/www/html/ps_1761/modules/wkpos/views/js/app/js/wkformatcurrency.js
/**
* NOTICE OF LICENSE
*
* This source file is subject to the Academic Free License version 3.0
...
// CONCATENATED MODULE: ./cashTransactions.js
/**
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Academic Free License version 3.0
...
function CashTransactionsModel(transaction) {
    var self = this;
...
function PaymentDetails(payment, index)
{
    var self = this;
...
function cashRegisterRequest(transactionData = {}) {
...
function OrderedCashMovement(transaction) {
    var self = this;
    this.reason = transaction.reason;
    this.amount = transaction.amount;
    this.displayAmount = asyncComputed(function () {
    ...
    this.digitalSign = transaction.digital_sign;
}
...
function getTotalCashMovement(cashMovement) {
...
function getOpeningCashMovement(cashMovement, idWkPosPayment) {
...
function getClosingCashMovement(cashMovement, idWkPosPayment) {
...
// CONCATENATED MODULE: ./poscashregistermodel.js
/**
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Academic Free License version 3.0
...
function PosCashRegisterViewModel(PosModel) {
    var self = this;
...
// CONCATENATED MODULE: ./cashregister.js
/**
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Academic Free License version 3.0
...
$(document).ready(function() {
    ...
    wkpos.on('afterPosModel', function(event) {
        ...
        if (typeof activeCashRegister != 'undefined' && activeCashRegister) {
            ...
            if (viewModel.cashRegisterStatus() == '0') {
                posViewModel.cashRegister.updateCashregisterStatus(1, 'pos_cart');
            }
            if (viewModel.cashRegisterStatus() == '1') {
                posViewModel.cashRegister.updateCashregisterStatus(0, 'pos_cash_register');
            }
        }
