<form method="post" class="formReprint">
    ...
    <div class="email-div">
        <label for="email-reprint" class="text-left">{l s='Add your email to send you a copy of this order:' mod='posnewreprint'}</label>
        ...
        <button type="submit" id="submitReprint" name="submitReprint" class="btn btn-block">
            {l s='Send me an email' mod='posnewreprint'}
        </button>
    </div>
